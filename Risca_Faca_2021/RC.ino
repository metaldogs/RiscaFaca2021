void ManualControl() {
  ...
  int leftMotorOutput = constrain(map(forward, 0, 255, 90, 150)  - (map(255 - backward, 0, 255, 30, 90) + (map(steering, -127, 127, 90, 110) - 90)), 30, 150);
  int rightMotorOutput = constrain(map(forward, 0, 255, 90, 150) - (map(255 - backward, 0, 255, 30, 90) - (map(steering, -127, 127, 90, 110) - 90)), 30, 150);
